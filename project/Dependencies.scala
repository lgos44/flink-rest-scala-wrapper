...
object Dependencies {
  ...
  private val playJsonExtensionVersion = "0.10.0"
  ...
  val playJsonext: ModuleID = "ai.x" %% "play-json-extensions" % playJsonExtensionVersion
  ...
  val all = Seq(playWs, slf4j, playJson, playJsonext, scalaTest, scalaMock)
}